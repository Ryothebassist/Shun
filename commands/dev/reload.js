...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        if(!args[0]) return message.reply('<:cross2:1237222628041822290> Missing __Category__ name')
        if(!args[1]) return message.reply('<:cross2:1237222628041822290> Missing __Command__ name')
